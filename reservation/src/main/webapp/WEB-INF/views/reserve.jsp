...
<head>
    ...
    <script src="resource/js/reservepage.js" type="text/javascript" charset="UTF-8"></script>
...
<body>
            ...
            <div class="ct_wrap">
                ...
                <div class="group_visual">
                    <div class="container_visual" style="width: 414px;">
                        <ul class="visual_img">
                            <li class="item" style="width: 414px;"> <img alt="공연메인이미지" class="img_thumb" src="https://ssl.phinf.net/naverbooking/20170217_264/1487312141947lTddT_JPEG/%B3%D7%C0%CC%B9%F6.jpg?type=ff1242_816"> <span class="img_bg"></span>
                            ...
                            <form class="form_horizontal">
                                ...
                                <div class="inline_form last"> <label class="label" for="message">예매내용</label>
                                    <div class="inline_control">
                                        <p class="inline_txt selected"><span id="reservationDate">${reserveDate}</span> 총 <span id="totalCount">0</span>매</p>
                                    </div>
                                </div>
                            </form>
                        </div>
    ...
    <footer>
 	...
 	<script type="template" id="briefInfo">
		 <em class="preview_txt_dsc">&#8361;{{lowPrice productPrices}} ~</em> 
	</script>
	<script type="template" id="detailInfo">
		<div class="store_details">
			<h3 class="in_tit">{{displayInfo/productDescription}}</h3>
            <p class="dsc">
            	장소: {{displayInfo/placeStreet}} <br>&emsp;&emsp;&nbsp;&nbsp;-{{displayInfo/placeName}}<br> 
            </p>
            <h3 class="in_tit">관람기간 및 시간</h3>
            <p class="dsc">
            ...
            <p class="dsc">
				{{#each productPrices}}
					...
					{{/getFee}}
				{{/each}}
				국가유공자, 장애인, 65세 이상 : 4,000원<br>			
				20인 이상 단체 : 20% 할인<br> 
			</p>
        </div>
	</script>
	<script type="template" id="ticket">
	{{#each productPrices}}
 		<div class="qty">
 			<div class="count_control">
  				<!-- [D] 수량이 최소 값이 일때 ico_minus3, count_control_input에 disabled 각각 추가, 수량이 최대 값일 때는 ico_plus3에 disabled 추가 -->
  			...
  			<div class="qty_info_icon"> 
				<strong class="product_amount"> 
					<span>{{#getType @index}}{{/getType}}</span> 
				</strong> 
				<strong class="product_price"> 
					<span class="price">{{price}}</span><span class="price_type">원</span> 
				</strong> 
				<em class="product_dsc" value="{{#dcPrice @index}}{{/dcPrice}}">{{#dcPrice @index}}{{/dcPrice}}원 ({{discountRate}}% 할인가)</em> 
			</div>
     	</div>
	{{/each}}
	</script>
