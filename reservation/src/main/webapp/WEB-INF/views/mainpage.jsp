...
<body>
    <div id="container">
        <div class="header">
            <header class="header_tit">
                <h1 class="logo">
                    <a href="#" onclick="return false;" class="lnk_logo" title="네이버"> <span class="spr_bi ico_n_logo">네이버</span> </a>
                    <a href="#" onclick="return false;" class="lnk_logo" title="예약"> <span class="spr_bi ico_bk_logo">예약</span> </a>
                </h1>
                <c:if test="${!empty sessionScope.resrvEmail}">
					 <a href="./myreservation" class="btn_my"> 
					 	<span class="viewReservation resrvEmail" title="에약이메일">${sessionScope.resrvEmail}</span> 
					 </a>
				</c:if>
                <c:if test="${empty sessionScope.resrvEmail}">
        ...
        <div class="event">
            ...
            <div class="section_event_lst">
                <p class="event_lst_txt">바로 예매 가능한 행사가 <span class="pink">0</span> 있습니다</p>
    ...
    <script type="rv-template" id="promotionItem">
    	<li class="item" style="background-image: url({saveFileImage});">
        	<a href="#" onclick="return false;"> <span class="img_btm_border"></span> <span class="img_right_border"></span> <span class="img_bg_gra"></span>
            	<div class="event_txt">
