...
<html lang="ko" class="no-js" >
   <head>
      ...
      <link href="resource/css/bookinglogin.css" rel="stylesheet">
      <script src="resource/js/util.js" type="text/javascript" charset="UTF-8"></script>
      <script src="resource/js/bookingloginpage.js" type="text/javascript" charset="UTF-8"></script>
   ...
   <body class="biz  ko" >
      ...
      <app>
         ...
         <footer  aria-hidden="false">
            <!---->
            <go-to-top >
               <div class="gototop"  onclick="return false;" aria-hidden="false"> <a href="https://m.booking.naver.com/#" class="lnk_top" > <span class="lnk_top_text" translate="CM-TOP">TOP</span> </a> </div>
            </go-to-top>
            <!----> <!---->
