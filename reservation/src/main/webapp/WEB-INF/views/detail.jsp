...
<head>
    ...
    <script src="resource/js/detailpage.js" type="text/javascript" charset="UTF-8"></script>
    <script src="resource/js/handlebars-v4.7.7.js" type="text/javascript" charset="UTF-8"></script>
...
<body>
            ...
            <div>
                <div class="section_visual">
                    <header>
		                ...
		                <c:if test="${!empty sessionScope.resrvEmail}">
							 <a href="./myreservation" class="btn_my"> 
							 	<span class="viewReservation" title="예약확인">${sessionScope.resrvEmail}</span> 
							 </a>
						</c:if>
		                <c:if test="${empty sessionScope.resrvEmail}">
                    ...
                    <div class="pagination">
                        ...
                        <div class="figure_pagination">
                            <span class="num" id="curIndex"></span>
                            <span class="num off">/ <span id="total"></span></span>
                        </div>
                    </div>
                ...
                <div class="section_store_details">
                    ...
                    <a href="#" onclick="return false;" class="bk_more _open"> <span class="bk_more_txt">펼쳐보기</span> <i class="fn fn-down2"></i> </a>
                    <a href="#" onclick="return false;" class="bk_more _close" style="display: none;"> <span class="bk_more_txt">접기</span> <i class="fn fn-up2"></i> </a>
                </div>
                ...
                <div class="section_info_tab">
                    ...
                    <ul class="info_tab_lst">
                        <li class="item active _detail">
                            <a href="#" onclick="return false;" class="anchor active"> <span>상세정보</span> </a>
                        </li>
                        <li class="item _path">
                            <a href="#" onclick="return false;" class="anchor"> <span>오시는길</span> </a>
                        </li>
                    </ul>
    ...
    <script type="detail-template" id="slideItem">
		{{#each productImages}}
    ...
    <script type="detail_template" id="reviewItem">
		{{#each comments}}
    		<li class="list_item">
   				<div>
					{{#if commentImages}}
        				<div class="review_area">
            				<div class="thumb_area">
                				<a href="#" onclick="return false;" class="thumb" title="이미지 크게 보기"> <img width="90" height="90" class="img_vertical_top" src="{{saveFileName this}}" alt="리뷰이미지"> </a> <span class="img_count">{{imgCount this}}</span>                                                </div>
					...
					{{/if}}
      		  		...
      		  		<div class="info_area">
							...
							<span class="name">{{email reservationEmail}}</span> 
