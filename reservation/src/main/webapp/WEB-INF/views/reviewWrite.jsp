...
<head>
	...
	<script src="resource/js/reviewWritepage.js" type="text/javascript"></script>
			...
			<div class="ct_wrap">
				...
				<div class="review_write_footer_wrap">
					<div class="review_write_footer">
						...
						<input type="file" class="hidden_input" id="reviewImageFileOpenInput" accept=".jpg, .png" multiple>
